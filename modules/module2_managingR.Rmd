...
se # relative path, up and back down the tree
...
```{r}
cpds = read.csv("../r-bootcamp-2018-master/data/cpds.csv")
write.csv(cpds,file = "1.csv",row.names = FALSE, quote = FALSE)
```
...
```{r}
pdf('myplot.pdf', width = 70, height = 70)
hist(air$DepTime)
dev.off()
